	...
	**/
	...
	var draw = function($picker, option, year, month, day, hour, min) {
		...
		if ((!isFutureOnly || !isCurrentMonth) && ((minDate == null) || (minDate < cDate.getTime()))
			...
			$link_before_month = $('<a>');
			$link_before_month.html('<i class="chevron left icon"></i>');
		...
		if ((maxDate == null) || (maxDate > cDate.getTime())) {
			$link_next_month = $('<a>');
			$link_next_month.html('<i class="chevron right icon"></i>');
		...
		if (isTodayButton) {
			...
			/*
				...
				Thankyou.
			*/
			$link_today.html('<i class="clock icon"></i>' + translate(locale,'now'));
	...
	var init = function($obj, opt) {
		...
		$picker.addClass('datepicker ui pointing compact segments');
		$obj.append($picker);
		...
		/* Header */
		var $header = $('<div>');
		$header.addClass('datepicker_header ui center aligned segment');
		$picker.append($header);
		/* InnerContainer*/
		var $inner = $('<div>');
		$inner.addClass('datepicker_inner_container ui segment');
		$picker.append($inner);
		/* Calendar */
		var $calendar = $('<div>');
		$calendar.addClass('datepicker_calendar');
		var $table = $('<table>');
		$table.addClass('datepicker_table ui celled compact table');
